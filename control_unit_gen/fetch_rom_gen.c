 ...
 * microcode counter reset.  byte_sel is 0 unless this code is selected. */
enum mux3 {
    M3_NONE = 0,
    M3_PC_INC,           /* 1 */
    M3_INTPC_INC,        /* 2 */
...
[PROC_FETCH] = {
    STEP(M1_PC_READ,  M2_MAR_WRITE,          M3_NONE,     M4_NONE, M5_NONE),
    STEP(M1_PC_READ,  M2_MAR_WRITE,          M3_BYTE_SEL, M4_NONE, M5_NONE),
    ...
    STEP(M1_MEM_READ, M2_INSTR_FRAME0_WRITE, M3_PC_INC,   M4_NONE, M5_PTER_ADDR_READ),
    STEP(M1_PC_READ,  M2_MAR_WRITE,          M3_NONE,     M4_NONE, M5_NONE),
    STEP(M1_MEM_READ, M2_INSTR_FRAME1_WRITE, M3_PC_INC,   M4_NONE, M5_PTER_ADDR_READ),
    STEP(M1_PC_READ,  M2_MAR_WRITE,          M3_NONE,     M4_NONE, M5_NONE),
    STEP(M1_MEM_READ, M2_INSTR_FRAME2_WRITE, M3_PC_INC,   M4_NONE, M5_PTER_ADDR_READ),
    STEP(M1_PC_READ,  M2_MAR_WRITE,          M3_NONE,     M4_NONE, M5_NONE),
    STEP(M1_MEM_READ, M2_INSTR_FRAME3_WRITE, M3_PC_INC,   M4_NONE, M5_PTER_ADDR_READ),
},
...
[PROC_FETCH2] = {
    STEP(M1_PC_READ,  M2_MAR_WRITE,          M3_NONE,     M4_NONE, M5_NONE),
    STEP(M1_PC_READ,  M2_MAR_WRITE,          M3_BYTE_SEL, M4_NONE, M5_NONE),
    STEP(M1_MEM_READ, M2_INSTR_FRAME0_WRITE, M3_PC_INC,   M4_NONE, M5_MAR_ADDR_READ),
    STEP(M1_PC_READ,  M2_MAR_WRITE,          M3_NONE,     M4_NONE, M5_NONE),
    STEP(M1_MEM_READ, M2_INSTR_FRAME1_WRITE, M3_PC_INC,   M4_NONE, M5_MAR_ADDR_READ),
    STEP(M1_PC_READ,  M2_MAR_WRITE,          M3_NONE,     M4_NONE, M5_NONE),
    STEP(M1_MEM_READ, M2_INSTR_FRAME2_WRITE, M3_PC_INC,   M4_NONE, M5_MAR_ADDR_READ),
    STEP(M1_PC_READ,  M2_MAR_WRITE,          M3_NONE,     M4_NONE, M5_NONE),
    STEP(M1_MEM_READ, M2_INSTR_FRAME3_WRITE, M3_PC_INC,   M4_NONE, M5_MAR_ADDR_READ),
},
